...
public class LoginPanel extends JPanel implements ActionListener
{
	...
	public LoginPanel(String loginprofile,ImageIcon imageicon,LoginPageFrame lpf) {
		...
		lblPassword.setBackground(new Color(1, 50, 90));
		...
		useridfield = new HintTextField("User ID");
		...
		lblEmailId.setBackground(new Color(1, 50, 90));
		...
		loginbutton.setBackground(new Color(1, 50, 90));
